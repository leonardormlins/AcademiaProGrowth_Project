...
public class Aluno extends Pessoa {
	...
	public Aluno(int id, String nome, String adress, String email, String telefone, List<Modalidade> modalidade,
			List<Shape> historicoShape, List<Aula> aula, String senha) {
